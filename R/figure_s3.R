...
ggsave("./plots/figure_s3_B.png", plot_ud, width=17.5, height=9.3, units="cm", dpi=700)
ggsave("./plots/figure_s3_C.png", plot_gu, width=17.5, height=14, units="cm", dpi=700)
...
plot_vd <- df_or %>%
  ...
  theme(legend.position="none") +
  scale_x_continuous(breaks = c(0.1, 1, 10, 100), labels = c("0.1", "1", "10", "100")) +
  coord_trans(x = "log10", xlim = c(0.02, 250)) +
...
#ggsave("./plots/figure_s3_A.png", plot_vd, width=17.5, height=10, units="cm", dpi=700)
#ggsave("./plots/figure_s3_B.png", plot_ud, width=17.5, height=10, units="cm", dpi=700)
#ggsave("./plots/figure_s3_C.png", plot_gu, width=17.5, height=10, units="cm", dpi=700)
